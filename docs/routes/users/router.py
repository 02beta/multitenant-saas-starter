...
async def activate_user(
    ...
    try:
        ...
        return UserPublic(
            ...
            avatar_url=activated_user.avatar_url,
            auth_user_id=activated_user.auth_user_id,
            is_active=activated_user.is_active,
            permissions=activated_user.permissions,
...
async def deactivate_user(
    ...
    try:
        ...
        return UserPublic(
            ...
            phone=deactivated_user.phone,
            avatar_url=deactivated_user.avatar_url,
            auth_user_id=deactivated_user.auth_user_id,
            is_active=deactivated_user.is_active,
            permissions=deactivated_user.permissions,
...
async def promote_to_superuser(
    ...
    try:
        ...
        return UserPublic(
            ...
            phone=promoted_user.phone,
            avatar_url=promoted_user.avatar_url,
            auth_user_id=promoted_user.auth_user_id,
            is_active=promoted_user.is_active,
            permissions=promoted_user.permissions,
...
async def revoke_superuser(
    ...
    try:
        ...
        return UserPublic(
            ...
            phone=revoked_user.phone,
            avatar_url=revoked_user.avatar_url,
            auth_user_id=revoked_user.auth_user_id,
            is_active=revoked_user.is_active,
            permissions=revoked_user.permissions,
