...
class MembershipRole(IntEnum):
    ...
    OWNER = 0  # can manage memberships for the organization and edit data associated with the organization
...
class Membership(SQLModel, AuditFieldsMixin, SoftDeleteMixin, table=True):
